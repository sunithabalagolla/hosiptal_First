  ...
  return (
    <div>
      ...
      <div className="showform">
        <button onClick={() => setShowForm(!showForm)} >+ Add Notice</button>
      </div>
          ...
          {Array.from({ length: 6 }, (_, weekIndex) => (
            <tr key={weekIndex}>
              {Array.from({ length: 7 }, (_, dayIndex) => {
                ...
                day.setDate(day.getDate() - currentDate.getDay() + dayIndex + weekIndex * 7);
                const formattedDate = getFormattedDate(day);
                const isCurrentDate = formattedDate === getFormattedDate(new Date());
